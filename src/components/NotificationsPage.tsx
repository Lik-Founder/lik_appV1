...
import { ArrowLeft, Check, Star, Trophy, Heart, MessageCircle, Users, MapPin, Clock, Gift, Zap, Crown } from 'lucide-react';
...
export const NotificationsPage: React.FC<NotificationsPageProps> = ({ onBack }) => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      reward: '+2 Lik Tickets, +1000 Lik Coins'
    },
    {
      id: '5',
      type: 'bounty',
    ...
    },
    {
      id: '9',
      type: 'restaurant',
      title: '🍽️ Restaurant Update',
      message: 'Bella Italia added a new seasonal menu! Check out their limited-time truffle pasta special.',
      timestamp: '1 day ago',
      isRead: true,
    ...
    },
    {
      id: '10',
      type: 'event',
      title: '🎪 Food Event Reminder',
      message: 'Don\'t forget! The "Street Food Spectacular" starts tomorrow at 2 PM. You\'re registered to attend!',
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 flex flex-col overflow-hidden">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <h3 className={cn(
                      "font-semibold nav-rum-raisin text-sm leading-snug",
                      notification.isRead ? "text-gray-700" : "text-purple-900"
                    )}>
                      {notification.title}
                    </h3>
                  ...
                  <p className={cn(
                    ...
                    notification.isRead ? "text-gray-600" : "text-purple-700"
                  )}>
      ...
      {/* Fun motivational footer for empty states */}
      {getFilteredNotifications().length === 0 && activeTab === 'all' && (
        <div className="p-4 bg-white/80 backdrop-blur-sm border-t border-purple-100">
          <div className="text-center">
            <p className="text-purple-600 text-sm nav-rum-raisin">
              🍽️ Keep exploring restaurants to unlock more achievements! 🌟
            </p>
          </div>
        </div>
      )}
