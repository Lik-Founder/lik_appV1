      ...
      <ScrollArea className="h-full">
        <div className="relative">
          ...
          >
            ...
            <div className="w-full min-w-full px-4 py-8 flex-shrink-0">
              {/* Profile Header */}
              <div className="flex flex-col items-center mb-8 max-w-xs mx-auto profile-header-mobile">
                {/* Profile Image with XP Ring */}
                <div className="relative mb-6">
                  <div className="relative">
                    {/* XP Progress Ring */}
                    <svg className="w-28 h-28 profile-avatar-mobile transform -rotate-90">
                      <circle
                        cx="56"
                        cy="56"
                        r="50"
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-2">
                    <div className="bg-primary text-primary-foreground rounded-full px-3 py-1 min-w-[48px] profile-level-badge-mobile flex items-center justify-center shadow-lg">
                ...
                <div className="text-center mb-5">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <CheckCircle size={18} className="text-blue-500" weight="fill" />
                  </div>
                  <p className="text-sm text-muted-foreground">@username</p>
                </div>

                {/* Account Stats */}
                <div className="flex justify-center gap-6 mb-5 w-full profile-stats-mobile">
                  <div className="text-center">
                    <p className="profile-stats-text font-bold">{mockFollowing}</p>
                    <p className="text-xs text-muted-foreground">Following</p>
                  </div>
                  <div className="text-center">
                    <p className="profile-stats-text font-bold">{mockFollowers}</p>
                    <p className="text-xs text-muted-foreground">Followers</p>
                  </div>
                  <div className="text-center">
                    <p className="profile-stats-text font-bold">{mockLikes}</p>
                ...
                {/* Action Buttons */}
                <div className="flex gap-2 w-full max-w-sm profile-buttons-mobile">
                  <Button 
                    variant="secondary" 
                    className="flex-1 h-10 text-sm font-medium rounded-xl min-w-0 px-3 profile-action-buttons"
            ...
            <div className="w-full min-w-full px-4 py-8 flex-shrink-0">
              <div className="flex flex-col h-full min-h-[500px] max-w-xs mx-auto profile-bio-mobile">
                {/* Profile Avatar */}
                ...
                <div className="flex-1 flex flex-col justify-center space-y-6">
                  <div className="bg-muted/50 rounded-2xl p-4 profile-achievement-card-mobile">
                  ...
                  <div className="bg-muted rounded-2xl p-4 profile-achievement-card-mobile flex items-center justify-between">
                    ...
                    <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center ml-3">
                ...
                {/* Social Links */}
                <div className="flex justify-center gap-3 mt-8 mb-6 profile-social-links-mobile">
                  <Button variant="ghost" size="sm" className="p-2 w-10 h-10 profile-social-button-mobile rounded-xl">
          ...
          {swipeIndex === 0 && (
            <div className="px-4 mb-6">
              <div className="flex gap-3 overflow-x-auto scrollbar-hide justify-center max-w-xs mx-auto">
                {/* Story 1 */}
            ...
            <div className="sticky top-[45px] z-10 bg-background/95 backdrop-blur-sm border-b border-border">
              ...
              <div className="px-4 py-3 border-b border-border">
                <div className="flex gap-2">
                  ...
                  <Button variant="outline" size="sm" className="h-10 px-3 rounded-xl flex-shrink-0">
              ...
              <div className="min-h-[300px]">
                <TabsContent value="posts" className="mt-0">
                  {userPosts.length === 0 ? (
                    <div className="p-6 text-center profile-empty-state-mobile">
                      <ForkKnife size={40} className="mx-auto mb-3 text-muted-foreground" />
                    ...
                    <div className="grid grid-cols-3 gap-0.5 p-3 profile-tab-content-mobile">
                      {userPosts.map(post => (
                        <button
                          key={post.id}
                          onClick={() => handlePostClick(post.id)}
                          className="aspect-square bg-muted overflow-hidden rounded-md touch-feedback"
                        >
                          <img
                            src={post.imageUrl}
                            alt={post.caption}
                ...
                <TabsContent value="likes" className="mt-0">
                  <div className="p-6 text-center profile-empty-state-mobile">
                    ...
                    <h3 className="text-base font-semibold mb-2">No liked posts</h3>
                ...
                <TabsContent value="favorites" className="mt-0">
                  <div className="p-6 text-center profile-empty-state-mobile">
                    <BookBookmark size={40} className="mx-auto mb-3 text-muted-foreground" />
                ...
                <TabsContent value="reposts" className="mt-0">
                  <div className="p-6 text-center profile-empty-state-mobile">
                    <Share size={40} className="mx-auto mb-3 text-muted-foreground" />
                    <h3 className="text-base font-semibold mb-2">No reposts</h3>
                ...
                <TabsContent value="guides" className="mt-0">
                  <div className="p-6 text-center profile-empty-state-mobile">
                    <Export size={40} className="mx-auto mb-3 text-muted-foreground" />
                    <h3 className="text-base font-semibold mb-2">No guides created</h3>
