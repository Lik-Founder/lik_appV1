        ...
        <div className="relative">
              ...
              <div className="flex flex-col items-center mb-4">
                ...
                <div className="relative mb-3">
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2">
                    <div className="bg-primary text-primary-foreground rounded-full w-10 h-5 flex items-center justify-center">
                      <span className="text-xs font-bold">{mockLevel}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs text-muted-foreground">{mockLocation}</span>
                </div>
              ...
              <div className="flex flex-col h-full min-h-[500px]">
                ...
                <div className="flex-1 flex flex-col justify-center space-y-6">
                  <div className="bg-muted/50 rounded-2xl p-4">
                    <p className="text-base font-semibold mb-2">What is your favorite food?</p>
                    <p className="text-sm text-muted-foreground">Pizza, especially Margherita with fresh basil</p>
                  </div>
          ...
          {swipeIndex === 0 && (
            <div className="sticky top-[45px] z-10 bg-background/95 backdrop-blur-sm border-b border-border">
              ...
              <TabsList className="grid w-full grid-cols-5 bg-transparent border-0 h-10">
                <TabsTrigger value="posts" className="flex flex-col items-center gap-0.5 h-full data-[state=active]:bg-transparent p-1">
                  <ForkKnife size={16} />
                </TabsTrigger>
                <TabsTrigger value="likes" className="flex flex-col items-center gap-0.5 h-full data-[state=active]:bg-transparent p-1">
                  <Heart size={16} />
                </TabsTrigger>
                <TabsTrigger value="favorites" className="flex flex-col items-center gap-0.5 h-full data-[state=active]:bg-transparent p-1">
                  <BookBookmark size={16} />
                </TabsTrigger>
                <TabsTrigger value="reposts" className="flex flex-col items-center gap-0.5 h-full data-[state=active]:bg-transparent p-1">
                  <Share size={16} />
                </TabsTrigger>
                <TabsTrigger value="guides" className="flex flex-col items-center gap-0.5 h-full data-[state=active]:bg-transparent p-1">
                  <Export size={16} />
                </TabsTrigger>
              </TabsList>
              ...
              <div className="px-3 py-2 border-b border-border">
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    <MagnifyingGlass size={14} className="absolute left-2.5 top-1/2 transform -translate-y-1/2 text-muted-foreground" />
                    <Input 
                      placeholder="Search for Posts"
                      value={searchTerm}
                      onChange={(e) => setSearchTerm(e.target.value)}
                      className="pl-9 bg-muted border-0 h-8 text-sm"
                    />
                  </div>
                ...
                <TabsContent value="posts" className="mt-0">
                  {userPosts.length === 0 ? (
                    <div className="p-8 text-center">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">Start sharing your food adventures!</p>
                      <Button 
                        className="instagram-gradient text-white border-0 h-8 text-sm"
                    ...
                    <div className="grid grid-cols-3 gap-0.5 p-3">
                      {userPosts.map(post => (
                        <button
                          ...
                          className="aspect-square bg-muted overflow-hidden rounded-md"
                        >
                          <img
                            src={post.imageUrl}
                            alt={post.caption}
