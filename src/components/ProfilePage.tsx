      ...
      <ScrollArea className="h-full">
        <div className="relative">
          ...
          >
            ...
            <div className="w-full min-w-full px-6 py-6 flex-shrink-0">
              {/* Profile Header */}
              <div className="flex flex-col items-center mb-6 max-w-sm mx-auto">
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                  ...
                  <span className="text-base text-muted-foreground">{mockLocation}</span>
                </div>
                ...
                <div className="flex gap-3 w-full max-w-sm">
                  <Button 
                    variant="secondary" 
                    className="flex-1 h-11 text-base font-medium rounded-xl px-6"
              ...
              <div className="flex flex-col h-full min-h-[500px] max-w-sm mx-auto">
                ...
                <div className="flex-1 flex flex-col justify-center space-y-8">
                  ...
                  <div className="bg-muted rounded-2xl p-6 flex items-center justify-between">
                    ...
                    <div className="w-16 h-16 bg-black rounded-xl flex items-center justify-center ml-4">
          ...
          {swipeIndex === 0 && (
            <div className="px-6 mb-8">
              <div className="flex gap-4 overflow-x-auto scrollbar-hide justify-center max-w-sm mx-auto">
                {/* Story 1 */}
                ...
                <div className="flex gap-3">
                  <div className="relative flex-1">
                    ...
                    <Input 
                      ...
                      className="pl-12 bg-muted border-0 h-12 text-base rounded-xl"
                    />
                  </div>
                  <Button variant="outline" size="sm" className="h-12 px-4 rounded-xl flex-shrink-0">
                ...
                <TabsContent value="posts" className="mt-0">
                  {userPosts.length === 0 ? (
                    <div className="p-8 text-center">
                      ...
                      <Button 
                        className="instagram-gradient text-white border-0 h-12 px-8 text-base"
