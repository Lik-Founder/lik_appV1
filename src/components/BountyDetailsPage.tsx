...
import { ArrowLeftIcon, MapPinIcon as MapPin, ClockIcon, StarIcon, UsersIcon, TrophyIcon, CurrencyDollarIcon, CameraIcon, ShareIcon, BookmarkIcon, CheckCircleIcon as CheckCircle } from '@heroicons/react/24/outline';
